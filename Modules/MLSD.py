...
def plot_threshold_sensitivity(image, interpreter, input_details, output_details, thresholds=np.linspace(0.01, 0.5, 50), dist_thr=20.0, save_path='threshold_sensitivity.png'):
    counts = [len(pred_lines(image, interpreter, input_details, output_details, score_thr=t, dist_thr=dist_thr)) for t in thresholds]
    plt.figure(figsize=(10, 6))
    plt.plot(thresholds, counts, linewidth=2, marker='o', markersize=4)
    plt.xlabel('Confidence Threshold', fontsize=12)
    plt.ylabel('Number of Lines Detected', fontsize=12)
    plt.title('Line Count vs Confidence Threshold', fontsize=14)

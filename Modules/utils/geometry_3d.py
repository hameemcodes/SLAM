...
def backproject_point_to_3d(x, y, depth_map, camera_matrix, depth_scale=1000.0):
    """
    ...
    # Convert inverse depth to depth (Depth Anything V2 outputs relative depth)
    Z = 1.0 / (depth_value + 1e-6)  # Add small epsilon to avoid division by zero
    Z = Z * depth_scale
